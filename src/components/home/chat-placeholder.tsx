...
const ChatPlaceHolder = () => {
	return (
		<div className='hidden md:flex w-3/4 bg-gray-secondary flex-col items-center justify-center py-10'>
			<div className='flex flex-col items-center w-full justify-center py-10 gap-4'>
				...
				<p className='text-3xl font-extralight mt-5 mb-2'>Download HiChat for Windows</p>
